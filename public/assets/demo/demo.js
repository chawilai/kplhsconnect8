...
demo = {
  ...
  initDashboardPageCharts: function() {
    ...
    myChart = new Chart(ctx, {
      type: 'pie',
      data: {
        labels: ['Princess', 'สปสช'],
        datasets: [{
          label: "Emails",
          pointRadius: 0,
          pointHoverRadius: 0,
          backgroundColor: ['#A1123E', '#2C974B'],
          borderWidth: 0,
          data: [1255, 200]
        }]
      },
    ...
    var ctx = document.getElementById('prep_med_left');
    var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ['All', 'Stop', '>90', '61-90', '31-60', '1-30', '<1'],
            datasets: [{
                label: '# of Votes',
                data: [1445, 592, 23, 51, 361, 215, 100],
                backgroundColor: [
                    'rgba(255, 99, 132, 1)',
                    'rgba(54, 162, 235, 1)',
                    'rgba(255, 206, 86, 1)',
    ...
    var a = {
      type: "line",
      data: {
        labels: ["มกรา", "กุมภา", "มีนา", "เมษา", "พฤษภา", "มิถุนา", "กรกฎา", "สิงหา", "กันยา", "ตุลา", "พฤศจิกา", "ธันวา"],
        datasets: [{
          ...
          fill: false,
          borderWidth: 3,
          data: [80, 78, 86, 96, 83, 85, 76, 75, 88, 90, 120, 130]
        }]
      },
      options: {
